<template>
  ...
  <mt-loadmore :autoFill=false :top-method="loadTop" @top-status-change="handleTopChange" :bottom-all-loaded="allLoaded" :bottomPullText="pullup" ref="loadmore" :bottom-method="loadbottom" @bottom-status-change="handlebottomChange">
    <!--612-->
    <!--<div>-->
    <div class="haschecked">
      <div class="content" v-for="(item,index) in list" style="background: white">
        <div>
          <h3>
            <span>预约单号</span>
            <span>{{item[0]}}</span>
        ...
        <ul>
          ...
          <li v-show="Ushowcar[0][index]">
            <span>随访车辆</span>
            <span>{{Uhascar[index]}}</span>
          </li>
    ...
    <!--<div v-show="allLoaded" style="width:100%;height:66px;text-align:center;line-height:50px;border:8px solid #EDEDED;box-sizing: border-box">没有更多数据</div>-->
